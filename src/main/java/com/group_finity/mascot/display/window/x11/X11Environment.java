...
import com.group_finity.mascot.display.window.x11.X.Display;
import com.group_finity.mascot.display.window.x11.X.Window;
import com.group_finity.mascot.display.window.x11.X.X11Exception;
import com.group_finity.mascot.display.window.x11.jna.X11Extra;
